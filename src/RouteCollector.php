...
final class RouteCollector
{
    ...
    public function addRoute(
        ...
        $route = new Route(
            ...
            scopeBindings: $this->currentGroup?->scopeBindings ?? false,
        );
    ...
    {
        $this->group('', $callback, scopeBindings: true);
    }

    public function scoped(callable $callback): void
    {
        $this->scopeBindings($callback);
    }
